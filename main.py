...
def compress_image(image_bytes, quality=85, width=None, height=None):
    try:
...
@app.post("/compress")
async def compress(image: UploadFile = File(...), quality: Optional[int] = 85, width: Optional[int] = None, height: Optional[int] = None):
    try:
